...
public class uiv {
	JFrame jFrame = new JFrame("V服务器使用界面");
    ...
    private JLabel a3 = new JLabel("Kc,v");
    private JTextField key1 = new JTextField();
    public uiv(String ming,String mi,String Kc_v) {
        //设置窗体的位置及大小
        jFrame.setBounds(600, 200, 550, 300);
        //设置一层相当于桌布的东西
    ...
    public void init(String ming,String mi,String Kc_v) {
        /*标题部分--North*/
